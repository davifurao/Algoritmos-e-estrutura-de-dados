...
//import java.io.*; debug na hora da construção  
import java.util.*; 
...
//  public No alterar(long atual,long valor_alterado) {
//	   Tree valor_buscar = new Tree();
//	  if (root == null) return null;
//	  No v= valor_buscar.buscar(atual);
//	  v.Boolean.parseBoolean();
//	  if (v = valor_alterado) {
//		  System.out.printn("O elemento já existe!");
//	  }
//	  if (v != null) {
//		  
//	  }
